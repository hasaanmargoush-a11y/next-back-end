...
import { db, usersTable, coursesTable, coursePhasesTable, lessonsTable, lessonContentBlocksTable, quizzesTable, quizQuestionsTable, quizQuestionOptionsTable, userQuizAttemptsTable, certificatesTable, userCertificatesTable } from "@workspace/db";
