...
import { db, usersTable, coursesTable, lessonsTable, enrollmentsTable, problemsTable, submissionsTable, articlesTable, navItemsTable, notificationsTable, platformSettingsTable, ideExecutionLogsTable, userActivityLogsTable, packsTable, badgesTable, userBadgesTable, tracksTable, dailyChallengesTable, securityEventsTable, securityBansTable, userCertificatesTable, certificatesTable, schoolLanguagesTable, schoolChaptersTable, schoolTopicsTable, userProjectsTable, projectStarsTable, problemSolutionsTable, duelsTable, userDailyChallengesTable, lessonProgressTable } from "@workspace/db";
