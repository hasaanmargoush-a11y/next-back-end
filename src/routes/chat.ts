...
import { db, usersTable, coursesTable, chatMessagesTable, chatReactionsTable, chatMutesTable, chatBansTable, notificationsTable, enrollmentsTable } from "@workspace/db";
